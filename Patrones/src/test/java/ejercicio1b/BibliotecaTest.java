...
class BibliotecaTest {
 ...
 void exportarSocioTest() {
	 ...
	 for (Map<String,String> persona: objetos) {
		 if (persona.get("nombre").equals("Arya Stark")) {
			 assertTrue(persona.get("email").equals("needle@stark.com"));	
			 assertTrue(persona.get("legajo").equals("5234-5"));}
		 else if (persona.get("nombre").equals("Tyroon Lannister")) {
			 assertTrue(persona.get("email").equals("tyron@thelannisters.com"));	
			 assertTrue(persona.get("legajo").equals("2345-2"));}
		 }
	 }
 
 @Test
 void exportarSocioTestJsonSimple() {
